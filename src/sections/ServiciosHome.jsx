    ...
    <section id="servicios-info" className="py-12 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-24 max-w-4xl">
          ...
          >
            ...
            <h2 className="text-[11vw] xs:text-[10vw] sm:text-7xl md:text-8xl font-serif leading-[0.9] tracking-tighter uppercase">
              SERVICIOS <br />
              <span className="text-brand-blue not-italic block font-serif">
                ESPECIALIZADOS
              </span>
            </h2>
        ...
        <div className="mt-24 flex flex-col items-center">
          ...
          <Link 
            to="/servicios" 
            className="px-12 py-5 border border-zinc-500 text-brand-cream font-bold hover:bg-brand-blue hover:border-brand-blue transition-all uppercase text-[10px] tracking-[0.2em] rounded-sm flex items-center gap-4 group"
          >
