        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {equipo.map((miembro, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group flex flex-col bg-mining-dark/5 border border-zinc-900 rounded-sm overflow-hidden hover:border-brand-blue/40 transition-all duration-500"
            >
              ...
              <div className="p-6 flex flex-col flex-grow bg-zinc-950/50">
                ...
                <p className="text-zinc-500 text-xs font-light leading-relaxed line-clamp-3 group-hover:text-zinc-400 transition-colors duration-500">
                  {miembro.descripcion}
                </p>
              </div>
            </motion.div>
